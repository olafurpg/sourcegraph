...
- Sourcegraph's minimum k8s version is now v1.14. Please see our Kubernetes [documentation](https://docs.sourcegraph.com/admin/install/kubernetes) for more information.This should not impact users with a recent release of Sourcegraph.
